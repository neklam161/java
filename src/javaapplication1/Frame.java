...
public class Frame extends javax.swing.JFrame {
    ...
    public void DBConnect() {
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/mysql", "root", "Rachid-123");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            try {
                    pst =con.prepareStatement("insert into etudiant values(?,?,?)");
                    pst.setString(1,id);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try{String name = getname.getText();
        String id=getid.getText();
        String age=getage.getText();
        
        pst=con.prepareStatement("update etudiant set nom=?,age=? where id=?;");
